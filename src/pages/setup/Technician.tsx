...
const technicians = [
  { id: 1, name: "Neil Dibbert", email: "Fredrick43@yahoo.com", department: "IT Department", group: "Maintenance", site: "Head Office, Branch A" },
  { id: 2, name: "Keith Bashirian", email: "Cynthia55@yahoo.com", department: "Administration", group: "Support", site: "Head Office" },
  { id: 3, name: "Rachael Block", email: "Joey88@gmail.com", department: "Human Resources (HR)", group: "Operations", site: "Branch A" },
  { id: 4, name: "Jesse Mraz", email: "Felix22@yahoo.com", department: "Finance", group: "Infrastructure", site: "Head Office" },
  { id: 5, name: "Norma Schmeler", email: "Elsie53@gmail.com", department: "Operations", group: "Services", site: "Branch A" },
];
          ...
          >
            ...
            <DialogTrigger asChild>
              {/* <Button className="bg-primary flex items-center gap-2">
                Add Technician <Plus className="w-4 h-4" />
              </Button> */}
