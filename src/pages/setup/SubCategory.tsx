...
const subCategories = [
  ...
  { id: 2, name: "License", category: "Software" },
  { id: 3, name: "Internet", category: "Network" },
  { id: 4, name: "Antivirus", category: "Firewall" },
  { id: 5, name: "Messaging", category: "Communication" },
];
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          <DialogTrigger asChild>
            {/* <Button className="bg-primary flex items-center gap-2">
                Add Sub Category <Plus className="w-4 h-4" />
              </Button> */}
          ...
          <DialogContent className="sm:max-w-[500px] bg-white">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div>
                ...
                <Input id="name" placeholder="Enter Sub Category Name" />
              </div>
