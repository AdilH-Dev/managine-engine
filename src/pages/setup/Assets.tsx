    ...
    <MainLayout title="Setup">
      <div className="mb-6 bg-white px-[24px] py-[15px] flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <div className="relative flex-1 min-w-[125x] lg:flex-none lg:w-[125px]">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input id="assetPrice" placeholder="Enter Asset Price" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <Input id="purchaseDate" placeholder="Select" />
                ...
                <div>
                  ...
                  <div className="relative">
                    <Input id="warrantyExpiry" placeholder="Select" />
                    <Calendar className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                  </div>
                </div>
              </div>
